...
const LoginPage: React.FC = () => {
  ...
  return (
    <main className="h-screen w-screen  ">
      <div className="flex h-full min-h-fit gap-6  overflow-auto bg-gray-100">
        {/* {windowSize.width >= 9120 ? (
        ...
        <div className="right ml-auto flex h-full w-full flex-col items-center gap-12 bg-white p-12 text-2xl font-extralight shadow-[0_0_6px_1px_rgba(0,0,0,0.25)]">
          {/* {windowSize.width < 9000 ? ( */}
          <>
